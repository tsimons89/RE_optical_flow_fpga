...
## Buttons
#set_property PACKAGE_PIN E18 [get_ports {btn[1]}]
#set_property IOSTANDARD LVCMOS12 [get_ports {btn[1]}]
#set_property PACKAGE_PIN M19 [get_ports {btn[3]}]
#set_property IOSTANDARD LVCMOS12 [get_ports {btn[3]}]
#set_property PACKAGE_PIN M20 [get_ports btn]
#set_property IOSTANDARD LVCMOS12 [get_ports btn]
#set_property PACKAGE_PIN C19 [get_ports {btn[0]}]
#set_property IOSTANDARD LVCMOS12 [get_ports {btn[0]}]
#set_property PACKAGE_PIN B19 [get_ports {btn[4]}]
...
set_property PACKAGE_PIN P27 [get_ports {sw[3]}]
...
## VGA Connector
set_property PACKAGE_PIN AH20 [get_ports {vga_pBlue[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pBlue[0]}]
set_property PACKAGE_PIN AG20 [get_ports {vga_pBlue[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pBlue[1]}]
set_property PACKAGE_PIN AF21 [get_ports {vga_pBlue[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pBlue[2]}]
set_property PACKAGE_PIN AK20 [get_ports {vga_pBlue[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pBlue[3]}]
set_property PACKAGE_PIN AG22 [get_ports {vga_pBlue[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pBlue[4]}]

set_property PACKAGE_PIN AJ23 [get_ports {vga_pGreen[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pGreen[0]}]
set_property PACKAGE_PIN AJ22 [get_ports {vga_pGreen[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pGreen[1]}]
set_property PACKAGE_PIN AH22 [get_ports {vga_pGreen[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pGreen[2]}]
set_property PACKAGE_PIN AK21 [get_ports {vga_pGreen[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pGreen[3]}]
set_property PACKAGE_PIN AJ21 [get_ports {vga_pGreen[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pGreen[4]}]
set_property PACKAGE_PIN AK23 [get_ports {vga_pGreen[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pGreen[5]}]

set_property PACKAGE_PIN AK25 [get_ports {vga_pRed[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pRed[0]}]
set_property PACKAGE_PIN AG25 [get_ports {vga_pRed[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pRed[1]}]
set_property PACKAGE_PIN AH25 [get_ports {vga_pRed[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pRed[2]}]
set_property PACKAGE_PIN AK24 [get_ports {vga_pRed[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pRed[3]}]
set_property PACKAGE_PIN AJ24 [get_ports {vga_pRed[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pRed[4]}]

set_property -dict {PACKAGE_PIN AF20 IOSTANDARD LVCMOS33} [get_ports vga_pHSync]
set_property -dict {PACKAGE_PIN AG23 IOSTANDARD LVCMOS33} [get_ports vga_pVSync]

## HDMI in
#set_property -dict { PACKAGE_PIN Y21   IOSTANDARD LVCMOS33 } [get_ports { hdmi_rx_cec }]; #IO_L2P_T0_12 Sch=hdmi_rx_cec
set_property -dict {PACKAGE_PIN AF28 IOSTANDARD TMDS_33} [get_ports TMDS_Clk_n]
set_property -dict {PACKAGE_PIN AE28 IOSTANDARD TMDS_33} [get_ports TMDS_Clk_p]
set_property -dict {PACKAGE_PIN AH29 IOSTANDARD LVCMOS33} [get_ports hpa]
set_property -dict {PACKAGE_PIN AJ28 IOSTANDARD LVCMOS33} [get_ports scl_io]
set_property -dict {PACKAGE_PIN AJ29 IOSTANDARD LVCMOS33} [get_ports sda_io]
set_property IOSTANDARD TMDS_33 [get_ports {TMDS_Data_n[0]}]
set_property PACKAGE_PIN AJ26 [get_ports {TMDS_Data_p[0]}]
set_property PACKAGE_PIN AK26 [get_ports {TMDS_Data_n[0]}]
set_property IOSTANDARD TMDS_33 [get_ports {TMDS_Data_p[0]}]
set_property IOSTANDARD TMDS_33 [get_ports {TMDS_Data_n[1]}]
set_property PACKAGE_PIN AG27 [get_ports {TMDS_Data_p[1]}]
set_property PACKAGE_PIN AG28 [get_ports {TMDS_Data_n[1]}]
set_property IOSTANDARD TMDS_33 [get_ports {TMDS_Data_p[1]}]
set_property IOSTANDARD TMDS_33 [get_ports {TMDS_Data_n[2]}]
set_property PACKAGE_PIN AH27 [get_ports {TMDS_Data_n[2]}]
set_property PACKAGE_PIN AH26 [get_ports {TMDS_Data_p[2]}]
...
create_clock -period 10.000 -name TMDS_Clk_p -waveform {0.000 5.000} [get_ports TMDS_Clk_p]
